...
class TestSentenceCount(unittest.TestCase):
    def test_at_least(self):
        ...
        self.assertFalse(rule.matches("This is only one sentence with multiple punctuations..."))
    ...
    def test_at_most(self):
        ...
        self.assertTrue(rule.matches("This is only one sentence with multiple punctuations..."))
    ...
    def test_get_prompt_at_least(self):
        rule = SentenceCountAtLeastRule(count=2)
        self.assertEqual(rule.get_prompt(), "The response must be at least 2 sentences.")
    ...
    def test_get_prompt_at_most_one(self):
        ...
        self.assertEqual(rule.get_prompt(), "The response must be no more than 1 sentence.")
